...
case "$1" in
	configure)
		...
		/usr/lpp/htx/etc/scripts_stx/stx.post_i
		[[ -f /usr/lpp/htx/etc/scripts/ioshutdown ]] && chmod +x /usr/lpp/htx/etc/scripts/ioshutdown
		ln -sf /usr/bin/perl /bin/perl
		ln -sf /usr/bin/awk /bin/awk
		ln -sf /usr/lpp/htx/bin/esrv /bin/esrv
