...
* Default - 	1 
*
* Keyword - 	prefetch_dcbtna
* Description - Whether to run prefetch dcbtna along with hxecache .
*				0 - No , 1 - Yes .
* Default - 	0 
*
* Keyword -		dscr
* Description -	In case DSCR is writable from user space, how to populate it.
*				DSCR_DEFAULT - Nothing to write, use the existing value of DSCR
*				DSCR_RANDOM	 - Randomise all the fields of the DSCR
*				DSCR_LSDISABLE - Set the Load/Store Disable field of DSCR, leave other fields as it is.
* Default -		DSCR_DEFAULT
*
* Keyword - 	seed
