...
* Rule 1 - L2 Rollover testcase without Prefetch
...
* Rule 2 - L3 Rollover testcase without Prefetch
...
* Rule 3 - L2 Bounce testcase without Prefetch
...
* Rule 4 - L3 Rollover testcase with Prefetch running with default value in DSCR.

rule_id				L3_ROLL_PF_DEF_4
target_cache	 	L3
compare				1
bound				0
target_set 			-1
...
* Rule 5 - L3 Rollover testcase with Prefetch running with Randomised values in DSCR.

rule_id				L3_ROLL_PF_RND_5
target_cache	 	L3
compare				1
bound				0
target_set 			-1
...
* Rule 6 - L3 Rollover testcase with Prefetch running with LSD bit set in DSCR.

rule_id				L3_ROLL_PF_LSDISABLE_6
target_cache	 	L3
compare				1
bound				0
target_set 			-1
